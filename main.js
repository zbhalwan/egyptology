const artifacts = [
    {
      ...
      image: "https://images.fineartamerica.com/images-medium-large-5/1-tomb-painting-of-osiris-brian-brake.jpg", // Placeholder image
      description: "",
      dates: "No actual date",
      source: "https://www.penn.museum/sites/expedition/abydos-and-the-cult-of-osiris/",
    },
    {
      id: 2,
      title: "Benben Mound",
      ...
      image: "https://upload.wikimedia.org/wikipedia/commons/c/c2/Pyramidion-satellite-kh%C3%A9ops.jpg", // Placeholder image
      description: "Benben is a pyramid or stunted obelisk. It was from this mound that the first god, Atum the creator, appeared.",
      dates: "No actual date; associated with the creation of the world and the first appearance of land from primordial waters (Nu)",
      source: "https://ebookcentral-proquest-com.revproxy.brown.edu/lib/brown/reader.action?docID=6213702&ppg=38",
    },
    {
      id: 3,
      ...
      image: "https://upload.wikimedia.org/wikipedia/commons/9/93/L%27Olympieion_%28Ath%C3%A8nes%29_%2830776483926%29.jpg", // Placeholder image
      description: "The temple was created to honor the Olympians and served as an athletic venue for the Olympic Games.",
      dates: "470–456 BCE",
    ...
    },
    {
      ...
      location: [25.2930, 32.5564], // Esna
      image: "https://lp-cms-production.imgix.net/2023-07/shutterstock2131993815.jpg", // Placeholder image
      description: "The Temple of Esna was the last Egyptian temple to be decorated with hieroglyphic texts. The temple was dedicated to an \"androgynous, nameless, omnipotent creator god\". The god manifested itself as both the male god Khnum/Khnum-Ra and the female deity Neith.",
    ...
    },
    {
      ...
      description: "This manuscript details the creation by Atum-Khepri of Shu, Tefnut, Geb, Nut, Osiris, Horus, Seth, Isis, and Nephthys through masturbation and spit. Additionally, it described the origin of mankind from Atum's tears.",
    ...
    },
    {
      ...
      image: "https://www.historyplace.com/specials/slideshows/cleopatra/cleo4.jpg", // Placeholder image
      description: "The \"Naos of the Decades\" has a cosmogonical inscription that describes the moment of creation when Shu separated the sky from the earth in the form of his children, Nut and Geb, following the Heliopolitan tradition.",
      dates: "Fourth century BCE",
      source: "https://escholarship.org/uc/item/8tf3j2qq",
    },
    {
      ...
      location: [25.7190, 32.6577], // Luxor
      image: "https://www.mediastorehouse.com/p/731/temple-khonsu-karnak-luxor-egypt-20th-century-14873246.jpg.webp", // Placeholder image
      description: "It identified Amun as the demiurge with Ptah-Tatenen. It also depicted the Ogdoad together with a group of 12 other gods to represent the forces by which the creator accomplished making the cosmos.",
    ...
    },
    {
      ...
      modernLocation: "Cairo, Egypt",
      location: [30.0478, 31.2336], // Cairo
      image: "https://followinghadrianphotography.com/wp-content/uploads/2020/02/48879962783_861658f6cf_5k.jpg?w=1200", // Placeholder image
      description: "According to Egyptian mythology, the Temple of Heliopolis of the gods was considered among the greatest spots, as it was the beginning of all creation. Sun god, Ra, was thought to preside over the earth and the heavens, and lit up the darkness with his light to create the heavens and the earth.",
      dates: "2465-2325 BCE",
      source: "https://escholarship.org/uc/item/8tf3j2qq",
    },
    {
    ...
    },
    {
      ...
      location: [38.4824, 22.5010], // Delphi
      image: "https://i0.wp.com/www.roger-pearse.com/weblog/wp-content/uploads/2018/09/Delphi-Athenas-Dome-2a.jpg?ssl=1", // Placeholder image
      description: "The oracle of Delphi was an institution that commanded huge respect across the ancient Mediterranean world for roughly 1,000 years, with individuals, kings, and Roman emperors coming to consult the oracle.",
      dates: "Late Ptolemaic Period",
    ...
    },
    {
      ...
      image: "https://www.ancient-origins.net/sites/default/files/field/image/Mount-Olympus.jpg", // Placeholder image
      description: "Mount Olympus was regarded as the abode of the gods and the site of the throne of Zeus. In Homer's Odyssey, the peak never has storms, and it basks in cloudless ether.",
      dates: "No date",
    ...
    },
    {
      ...
      image: "https://corfuoutdoor.com/web-assets/uploads/2021/02/acheron-river-outdoor-activities-03.jpg", // Placeholder image
      description: "During the 10-year Titanomachy, where Titans fought the Olympians for control of the universe, the Titans maintained their strength by drinking from the Acheron River. Angered by this, Zeus cursed the river. Now, the Acheron River is believed to be one of the five mythical waterways that, in Greek mythology, are said to lead into the underworld.",
      dates: "8th Century BCE (first described by Greek poet Homer)",
      source: "https://www.nationalgeographic.com/travel/article/greece-river-to-underworld-now-lures-adventure-travelers",
    },
    {
      id: 13,
      title: "Mount Helicon",
      ...
      description: "This mountain was home to the muses and where Hesiod also resided.",
      dates: "N/A",
    ...
    },
    {
      ...
      image: "https://www.britishmuseum.org/sites/default/files/styles/uncropped_large/public/2022-07/Achilles-amphora-1280x1182.jpg?itok=9OnEzaBo", // Placeholder image
      description: "The location of the epic Trojan War, where the mighty city of Troy was besieged for 10 years by the Greeks, who sailed across the Aegean Sea to take revenge for a grave insult – the abduction of a woman.",
      dates: "NA",
    ...
    },
    {
      ...
      image: "https://img.atlasobscura.com/3yPb1GAilBDN95ckngEuQg7rwyurScIZZ8jbWZyvjA8/rt:fit/h:400/q:81/sm:1/scp:1/ar:1/aHR0cHM6Ly9hdGxh/cy1kZXYuczMuYW1h/em9uYXdzLmNvbS91/cGxvYWRzL3BsYWNl/X2ltYWdlcy9kM2Vm/MjAzYy1kN2E4LTQ1/OWMtYmU5OS1jOWNi/NDJlNjAwMDAzMzFm/NDgyYTU1ODNjZDk1/NGRfUDFCTUc2Lmpw/Zw.webp", // Placeholder image
      description: "According to myths, Zeus would take refuge in this cave whenever he angered his brother Poseidon, ruler of the sea. The cave helped Zeus escape the big storms that Poseidon would conjure up.",
      dates: "NA",
    ...
    },
    {
      ...
      location: [38.0420, 23.5420], // Elefsina
      image: "https://www.heritagedaily.com/wp-content/uploads/2021/08/15055792273-bdbca2569b-k-scaled.jpg", // Placeholder image
      description: "According to myths, this cavern holds the passage that Persephone– Demeter's daughter, whom Hades kidnapped–used to travel to and from the underworld. The cave is described as having odd vegetation growing out of its crevices, creating unusual wind patterns, and dark indentations and odd cracks along the walls in the rear.",
      dates: "NA",
      source: "https://www.efada.gr/en-us/Archaeological-Sites-Monuments/Eleusis/Archaeological-Site-of-Eleusis/ploutonion",
    },
    {
      id: 20,
      title: "Tiber River",
    ...
    },
    {
      ...
      image: "https://static.wixstatic.com/media/e41b5c_5f12abc2ed614742ac47f306df5411ad~mv2.jpg/v1/fill/w_2500,h_1666,al_c/e41b5c_5f12abc2ed614742ac47f306df5411ad~mv2.jpg", // Placeholder image
      description: "According to the myth, the fountain was built on the place where a young girl revealed the source of a water spring to Roman soldiers in the 1st century BC. It was believed that this spring was blessed by the gods, and the girl was their messenger. The soldiers built the fountain to honor the girl and the water.",
      dates: "18th Century",
      source: "https://www.google.com/search?q=trevi+fountain+maiden+myth&sca_esv=d111ac6bd73ca852&rlz=1C5CHFA_enUS919US919&biw=868&bih=788&ei=OA79Z4-VIYSg5NoPuNWQ2Q8&ved=0ahUKEwiPkfmR0deMAxUEEFkFHbgqJPsQ4dUDCBA&uact=5&oq=trevi+fountain+maiden+myth&gs_lp=Egxnd3Mtd2l6LXNlcnAiGnRyZXZpIGZvdW50YWluIG1haWRlbiBteXRoMgUQIRigATIFECEYoAEyBRAhGKABMgUQIRigATIFECEYoAEyBRAhGJ8FSLAGUAxY0wRwAHgBkAEAmAGiA6ABywmqAQcwLjMuNC0yuAEDyAEA-AEBmAIFoALiCcICBRAhGKsCmAMAkgcHMC4zLjQtMqAHwxuyBwcwLjMuNC0yuAfiCQ&sclient=gws-wiz-serp#:~:text=View%20Article%3A%20Aqueducts,%E2%80%BA%20floods%20%E2%80%BA%20TheTreviFountain",
    },
    {
      id: 24,
